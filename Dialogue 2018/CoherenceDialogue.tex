...
\begin{tabularx}{\textwidth}{>{\hsize=30pt}X |cccccc|}
\multirow{6}{30pt}{Most likely topic} & 
    Группе & астрономов & удалось & обнаружить \\
        & \topicsquare{blue!66} & 
        \topicsquare{my-red!90} &
        \topicsquare{my-red!45} & 
        \topicsquare{blue!33} \\ 
     &
     &
    \multicolumn{2}{@{}c@{}}{
        $\underbrace{\hspace*{\dimexpr6\tabcolsep+2\arrayrulewidth}\hphantom{\text{астрономов удалось}}}_{l_1=2}$} &     
    \multicolumn{1}{c}{} \\
& звезду, & обращающуюся & вокруг & чёрной & дыры \\
        & 
        \topicsquare{my-red!75} &
        \topicsquare{my-red!45} & 
        \topicsquare{gray!55} &
        \topicsquare{my-red!75} &
        \topicsquare{my-red!75} \\
    &
    \multicolumn{2}{@{}c@{}}{
        $\underbrace{\hspace*{\dimexpr6\tabcolsep+2\arrayrulewidth}\hphantom{\text{звезду, обращающуюсся}}}_{l_2=2}$} &
    & 
    \multicolumn{2}{@{}c@{}}{
        $\underbrace{\hspace*{\dimexpr6\tabcolsep+2\arrayrulewidth}\hphantom{\text{чёрной дыры}}}_{l_3=2}$} 
\end{tabularx}
\endgroup
